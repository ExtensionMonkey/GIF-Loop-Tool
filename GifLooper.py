...
class SimpleGifEditor:
    ...
    def create_widgets(self):
        ...
        # Attribution and donation link
        attribution_label = tk.Label(self.root, text="Simple GIF Looper by i_like_lips", fg="black", cursor="hand2")
        ...
        donation_label = tk.Label(self.root, text="Leave a friend of mine a coffee.", fg="grey", cursor="hand2")
        donation_label.pack(pady=5)
        donation_label.bind("<Button-1>", lambda e: self.open_link("https://www.paypal.com/paypalme/MSMJ660"))
